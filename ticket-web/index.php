        ...
        <div class="row">
            <div  class="col s12">
                ...
                Booking
                 ...
                 <form class="col s12" action="public_html/transaction.php" method="post" autocomplete="off">
    ...
    <div class="container" >
        <div class="row" >
            <div  class="col s12">
                ...
                <form class="col s12" action="public_html/transaction.php" method="post" enctype="multipart/form-data" autocomplete="off">
				<div class="input-field col s12">
...
CP	: 082137241242 (Ridho Aryan R)
    ...
    <!--  Scripts-->
    <script src="public_html/min/plugin-min.js"></script>
    <script src="public_html/min/custom-min.js"></script>
<script>
